...
const api = {
  ...
  switchModelProfile: (threadId: string, selection: string) => ipcRenderer.invoke("loom:model-switch", threadId, selection),
  switchCurrentModel: (threadId: string, selection: string, model: string) => ipcRenderer.invoke("loom:model-switch-current", threadId, selection, model),
  ...
  setReasoning: (threadId: string, selection: string, model: string, kind: string, value: string) =>
    ipcRenderer.invoke("loom:reasoning-set", threadId, selection, model, kind, value),
